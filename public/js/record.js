        ...
        if (userId) {
           $.ajax({
            ...
            success: function(data) {
                ...
                $('#fullname').text(data.firstname + ' ' + data.middlename + ' ' + data.lastname);
                ...
                $('#husband_fullname').text(data.husband_firstname + ' ' + data.husband_middlename + ' ' + data.husband_lastname);
                $('#husband_contact_number').text(data.husband_contact_number); 
                ...
                $('#address').text( 'Barangay ' + data.barangay + ',' + data.city + ',' + data.province);
                //TERMS
                ...
                ultrasoundData.forEach(function(record) {
                    ...
                    var img = $('<img>').attr('src', record.attachment).attr('alt', 'ultrasound').css('max-width', '100px');
                    var attachmentCell = $('<td>').addClass('text-center').append(img);
