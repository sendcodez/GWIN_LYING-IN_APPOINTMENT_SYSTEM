        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    -->
                        ...
                        @if (Auth::user()->usertype == '1')
                            <li class="dropdown">
                                <a href="{{ route('admin.calendar') }}"
                                    class="dropdown-toggle no-arrow @isActiveRoute('admin.calendar')">
                                    <span class="micon bi bi-person-walking"><svg xmlns="http://www.w3.org/2000/svg"
                                            width="25" height="25" class="bi bi-person-walking"
                                            viewBox="0 0 16 16">
                                            <path
                                        ...
                                        </svg></span><span class="mtext" style="font-size:13px">Add Walk In
                                        Appointments</span>
                                </a>
                            </li>
                        @endif
                        ...
                        <li class="dropdown">
                            <a href="{{ route('doctor.create') }}"
                                class="dropdown-toggle no-arrow @isActiveRoute('doctor.create')">
                        ...
                        <li class="dropdown">
                            <a href="{{ route('record.index') }}"
                                class="dropdown-toggle no-arrow @isActiveRoute('record.index')">
                        ...
                        @if (Auth::user()->usertype == '0')
                            <li class="dropdown">
                                <a href="{{ route('report.index') }}"
                                    class="dropdown-toggle no-arrow @isActiveRoute('report.index')">
                            ...
                            <li class="dropdown">
                                <a href="{{ route('service.index') }}"
                                    class="dropdown-toggle no-arrow @isActiveRoute('service.index')">
                        ...
                        @if (Auth::user()->usertype == '0')
                            <li class="dropdown">
                                <a href="{{ route('activity.show') }}"
                                    class="dropdown-toggle no-arrow @isActiveRoute('activity.show')">
                            ...
                            <li class="dropdown">
                                <a href="{{ route('user.create') }}"
                                    class="dropdown-toggle no-arrow @isActiveRoute('user.create')">
                        ...
                        <li class="dropdown">
                            <a href="{{ route('website.index') }}"
                                class="dropdown-toggle no-arrow @isActiveRoute('website.index')">
                    ...
                    @if (Auth::user()->usertype == '3')
                        <li class="dropdown">
                            <a href="{{ route('appointment.index') }}"
                                class="dropdown-toggle no-arrow @isActiveRoute('appointment.index')">
                    ...
                    @if (Auth::user()->usertype == '2')
                        <li class="dropdown">
                            <a href="{{ route('mypatients.index') }}"
                                class="dropdown-toggle no-arrow @isActiveRoute('mypatients.index')">
                    ...
                    @if (Auth::user()->usertype == '3')
                        <li class="dropdown">
                            <a href="{{ route('myrecord.index') }}"
                                class="dropdown-toggle no-arrow @isActiveRoute('myrecord.index')">
