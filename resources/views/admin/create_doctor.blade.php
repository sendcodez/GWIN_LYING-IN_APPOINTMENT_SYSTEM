                                ...
                                <td class="table-plus">
                                    <div class="name-avatar d-flex align-items-center">
                                        <div class="avatar mr-2 flex-shrink-0">
                                            <img src="{{ asset('doc_image/' . $doctor->image) }}" class="border-radius-100 shadow" width="40" height="40" alt="{{ $doctor->firstname }} {{ $doctor->lastname }}">
                                        </div>
                                        <div class="txt">
                                            <div class="weight-600">{{ $doctor->firstname }} {{ $doctor->lastname }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            <a class="dropdown-item" href="{{ route('doctor.show', ['doctor' => $doctor->id]) }}"><i class="dw dw-eye"></i> View</a>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" value="{{ $doctor->firstname}}" name="firstname" class="form-control" required>
                                    </div>
                                    <label>Middle name</label>
                                    <div class="form-group">
                                        <input type="text" value="{{ $doctor->middlename}}" name="middlename" class="form-control">
                                    </div>
                                    <label>Last name</label>
                                    <div class="form-group">
                                        <input type="text" name="lastname" value="{{ $doctor->lastname}}" class="form-control" required>
                                    </div>
                                    <label>Contact number</label>
                                    <div class="form-group">
                                        <input type="text" name="contact_number" value="{{ $doctor->contact_no }}"  class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label>Address</label>
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="expertise" value="{{ $doctor->expertise}}" class="form-control" required>
                                    </div>
                                    <label>Email</label>
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <img src="{{ asset('doc_image/' . $doctor->image) }}" class="existing-image" width="100" height="100" alt="Current Image">
                                    </div>
                                </div>
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="daySelect_edit" class="selectpicker form-control" data-size="5"
                                                data-style="btn-outline-secondary" multiple data-actions-box="true"
                                                data-selected-text-format="text" name="day[]">
                                                <optgroup label="Days">
                                                    @php
                                                        $selectedDays = $doctor->availabilities->pluck('day')->toArray();
                                                    @endphp
                                ...
                                <div id="timeInputs_edit" class="col-md-12">
                                    @foreach($doctor->availabilities as $availability)
                                        ...
                                        <div class="form-group">
                                            <label>From:</label>
                                            <input type="time" name="sched_in[]" placeholder="From" class="form-control" value="{{ $availability->start_time }}">
                                        </div>
                                        <div class="form-group">
                                            <label>To:</label>
                                            <input type="time" name="sched_out[]" placeholder="To" class="form-control" value="{{ $availability->end_time }}">
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary prev_edit float-right"
                                      >
            ...
            <div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel"
               ...
               <div class="modal-dialog modal-dialog-centered">
                   <div class="modal-content">
                       ...
                       <div class="modal-body">
                           <form id="multiStepForm" method="POST" action="{{ route('doctor.store') }}" enctype="multipart/form-data">
                               @csrf
                               <div id="step1">
                                   <!-- Step 1: Personal Information -->
                                   <div class="row">
                                   ...
                                   <div class="row">
                                    <div class="col-md-12">
                                       ...
                                       <div id="timeInputsPlaceholder" style="display:none;">
                                           <label>From:</label>
                                           <div class="form-group">
                                               <input type="time" name="sched_in" placeholder="From" class="form-control">
                                           </div>
                                           <label>To:</label>
                                           <div class="form-group">
                                               <input type="time" name="sched_out" placeholder="To" class="form-control">
                                           </div>
                                       </div>
                                   </div>
                                   <div class="modal-footer">
...
$(document).ready(function() {
    $('#daySelect').on('change', function() {
        ...
        $(this).find('option:selected').each(function() {
            ...
            $('#timeInputs').append(label).append(fromLabel).append(inputStart).append(toLabel).append(inputEnd);
        });
    });
});
...
$(document).ready(function() {
    $('#daySelect_edit').on('change', function() {
        ...
        $(this).find('option:selected').each(function() {
            ...
            $('#timeInputs_edit').append(label).append(fromLabel).append(inputStart).append(toLabel).append(inputEnd);
        });
    });
});
