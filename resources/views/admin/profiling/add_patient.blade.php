            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div id="printableForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                <label style="font-weight:700">Maiden Name (If Married)</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                <label style="font-weight:700">Civil Status</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                <label style="font-weight:700">Religion</label>
                                <input type="text" name="religion" class="form-control" required="true" />
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                <label style="font-weight:700">Occupation</label>
                                <input type="text" name="occupation" class="form-control" required="true" />
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                <label style="font-weight:700">Nationality</label>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label style="font-weight:700">Province</label>
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label style="font-weight:700">Barangay</label>
